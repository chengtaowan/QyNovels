...
import com.jdhd.qynovels.textconvert.ShowChar;
import com.jdhd.qynovels.textconvert.ShowLine;
...
public class ReaderResolve {
    ...
    protected void drawMarginArea(Canvas canvas) {
        ...
        //step4.在边缘区域画总百分比
        percent = (float) mChapterIndex * 100 / mChapterSum + (float) (mPageIndex + 1) * 100f / mPageSum / mChapterSum;
